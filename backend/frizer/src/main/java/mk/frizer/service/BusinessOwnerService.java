...
public interface BusinessOwnerService {
    ...
    Optional<BusinessOwner> updateBusinessOwner(Long id, String email, String password, String firstName, String lastName, String phoneNumber, Role role, List<Salon> salonList);
